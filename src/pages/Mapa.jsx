...
const S = {
  ...
  pill: { background: 'rgba(17,23,38,0.9)', border: '1px solid var(--card-border)', borderRadius: 999, padding: '8px 15px', color: 'var(--ink)', fontSize: 12, fontWeight: 900, letterSpacing: 1 },
  pillLive: { border: '1px solid var(--cyan)', color: 'var(--cyan)', boxShadow: '0 0 8px rgba(53,231,225,0.4)' },
  monitor: { position: 'absolute', top: 'max(env(safe-area-inset-top), 10px)', marginTop: 42, right: 12, width: 210, background: 'rgba(10,14,26,0.96)', border: '1px solid var(--cyan)', borderRadius: 14, padding: 14, zIndex: 15, boxShadow: '0 0 12px rgba(53,231,225,0.3)' },
  ...
  joyBtn: { width: 36, height: 36, borderRadius: 10, background: 'rgba(17,23,38,0.9)', border: '1px solid var(--cyan)', color: 'var(--cyan)', fontSize: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', touchAction: 'none', userSelect: 'none' },
