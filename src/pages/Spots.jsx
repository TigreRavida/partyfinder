...
const S = {
  root: { flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', position: 'relative' },
  scroll: { flex: 1, minHeight: 0, overflowY: 'auto', paddingBottom: 20 },
  ...
  cta: { margin: '4px 16px 16px', padding: 20, fontSize: 16, fontWeight: 900, letterSpacing: 1, color: '#fff' },
